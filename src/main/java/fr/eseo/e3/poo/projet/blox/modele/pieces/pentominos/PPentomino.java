...
public class PPentomino extends Pentomino {
    ...
    protected void setElements(Coordonnees coord, Couleur coul) {
        ...
        this.getElements()[2] = new Element(new Coordonnees(coord.getAbscisse() - 1, coord.getOrdonnee() + 1), coul);
        this.getElements()[3] = new Element(new Coordonnees(coord.getAbscisse(), coord.getOrdonnee() + 1), coul);
        this.getElements()[4] = new Element(new Coordonnees(coord.getAbscisse(), coord.getOrdonnee() - 1), coul);
